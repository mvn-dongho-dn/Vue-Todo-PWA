    ...
    <div class="auth-form-content">
      ...
      <div class="tab-content">
        ...
        <div class="social-login">
          <span class="facebook" @click="loginFb">
          ...
          <span class="twitter" @click="loginTt">
